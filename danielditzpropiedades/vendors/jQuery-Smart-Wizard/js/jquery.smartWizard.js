...
function SmartWizard(target, options) {
    ...
    this.elmStepContainer = $('<div align="center"></div>').addClass("stepContainer");
    ...
    var _showStep = function($this, stepIdx) {
        ...
        if(stepIdx != $this.curStepIdx){
            if($.isFunction($this.options.onLeaveStep)) {
                ...
                //$this.options.onLeaveStep.call($this,$(curStep), context);

                $.when($this.options.onLeaveStep.call($this,$(curStep), context)).done(function(respose){
                    console.log("RESPONSE: "+respose);
                    if (respose){
                        return _showCStep($this, stepIdx);
                    }
                    return false;
                });
            }else{
    ...
    var _showCStep = function($this, stepIdx){
        var selStep = $this.steps.eq(stepIdx);
        var curStep = $this.steps.eq($this.curStepIdx);
    ...
    SmartWizard.prototype.fixHeight = function(){
        ...
        console.log($(id).outerHeight(true));
        this.elmStepContainer.height($(id).outerHeight(true)+50);
    }
