                                        ...
                                        <div class="x_content" align="center" id="personViewContent">
                                            <div class="container" style="margin: 0 auto;width:80%;">
                                                ...
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        <div class="short-div" style="text-align: left;">
                                                            <label for="fNacimientoPersona" class="control-label">Fecha Nacimiento<span class="required">*</span></label>
                                                        </div>
                                                        <div class="short-div input-prepend input-group">
                                                            <input type="text" id="fNacimientoPersona" required="required" class="form-control">
                                            ...
                                            <div class="container" style="margin: 0 auto;width:80%;">
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-5">
                                                        <div class="short-div" style="text-align: left;">
                                                            <label for="callePersona_input" class="control-label">Calle<span class="required">*</span></label>
                                                        </div>
                                                        <div class="short-div">
                                                            <input type="text" id="callePersona_input" required="required" class="form-control" list='calleListid'>
                                                    ...
                                                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                                        <div class="short-div" style="text-align: left;">
                                                            <label class="control-label" for="nroPersona_input">Nro<span class="required">*</span></label>
                                                        </div>
                                                        <div class="short-div">
                                                            <input type="text" id="nroPersona_input" required="required" class="form-control" list='nroListid'>
                                                ...
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                        <div class="short-div" style="text-align: left;">
                                                            <label for="ciudadPersona_input" class="control-label">Ciudad<span class="required">*</span></label>
                                                        </div>
                                                        <div class="short-div">
                                                            <input type="text" id="ciudadPersona_input" required="required" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                        <div class="short-div" style="text-align: left;">
...
<script src="js/personas_edit.js"></script>
