            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Propiedades en Contrato</h2>
                                <ul class="nav navbar-right panel_toolbox" style="min-width:45px;"">
                                <button type="button" data-page="nuevo_alquiler_contrato.php" onclick="addPropiedad();" class="btn btn-primary" style="margin-left: 30px;">Nueva Propiedad</button>
...
<script src="js/alquileres_contrato.js"></script>
