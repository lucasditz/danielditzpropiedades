            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>VER Propiedad Disponible</h2>
                                <ul class="nav navbar-right panel_toolbox" style="min-width:45px;"">
                                <button type="button" onclick="habilitarContrato();" class="btn btn-primary" style="margin-left: 30px;">Generar Conrato</button>
                                </ul>
                                <div class="clearfix"></div>
                                <div class="x_content">
                                    <br>
                                    ...
                                    <div id="wizard" class="form_wizard wizard_horizontal">
                                        ...
                                        <div align="center" id="step-1" class="content" style="width: 80%; text-align: center; display: none; height: auto;">
                                            <?php include_once "components/inmueble_view.php" ?>
                                        </div>
                                        <!--------- FOTOS INMUEBLES ---------------->
                                        ...
                                        <div align="center" id="step-3" class="content" style="width: 80%; text-align: center; display: none;">
                                            <?php include "components/propietario_form.php" ?>
                                        </div>
                                        <!-------------- DATOS CONTRATO ------------------>
...
<script src="js/alquileres_disponibles_ver.js"></script>
