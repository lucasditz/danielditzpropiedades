...
function checkDataNotEmpty(){
    if (document.getElementById("nombrePersona_input").value == "" || document.getElementById("apellidoPersona_input").value == "" ||
        document.getElementById("dniPersona_input").value == "" || document.getElementById("fNacimientoPersona").value == "" ||
        document.getElementById("callePersona_input").value == "" || document.getElementById("nroPersona_input").value == "" ||
