...
function generateContract(){
    ...
    console.log(JSON.stringify(alquilerPeriodos));
    console.log(idInmuebleAlquiler+"-"+$('#depositoValue').val()+"-"+$('#honorariosValue').val()+"-"+selectedInquilino.id+"-"+selectedGarante.id+"-"+window.profileID);
    $.ajax({
        url: url,
        type: 'post',
        headers: {'X-Auth':userToken},
...
function goToAlquileresContrato(){
    console.log("alquileres_contrato.php");
