    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response.data.personas, function () {
                ...
                '<td style="text-align: center;vertical-align: middle;"><i class="fa fa-eye fa-2x actionImage" onclick="showperson($(this),$(this).parent().parent());"></i></td>' +
                '<td style="text-align: center;vertical-align: middle;"><i class="fa fa-edit fa-2x actionImage"  onclick="editPerson($(this),$(this).parent().parent());"></i></td>' +
                '<td style="text-align: center;vertical-align: middle;"><i class="fa fa-times-circle fa-2x actionImage" onclick="deletePerson($(this).parent().parent());"></i></td></tr>';
