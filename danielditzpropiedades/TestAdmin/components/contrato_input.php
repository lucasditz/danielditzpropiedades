                    ...
                    <div class="x_content">
                        ...
                        <div class="row" align="center">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="firstStartDate" required="required" class="form-control">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="firstEndDate" required="required" class="form-control">
                                    <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div id="secondVariationRow" class="row" align="center" style="display: none">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="secondStartDate" required="required" class="form-control">
                                    <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="secondEndDate" required="required" class="form-control">
                                    <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div id="thirdVariationRow" class="row" align="center" style="display: none">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="thirdStartDate" required="required" class="form-control">
                                    <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="thirdEndDate" required="required" class="form-control">
                                    <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div id="fourthVariationRow" class="row" align="center" style="display: none">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="fourthStartDate" required="required" class="form-control">
                                    <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                ...
                                <div class="short-div input-prepend input-group">
                                    <input type="text" id="fourthEndDate" required="required" class="form-control">
                                    <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4">
