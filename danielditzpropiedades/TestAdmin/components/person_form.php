                ...
                <div id="personaNewContent" class="x_content" style="display: none">
                    ...
                    <div class="container" style="margin: 0 auto;width:80%;">
                        ...
                        <div class="row" style="margin: 0 auto;width:80%;">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="short-div" style="text-align: left;">
                                    <label class="control-label" for="provinciaPersona">Provincia<span class="required">*</span></label>
                                </div>
                                <div class="short-div">
                                    <input type="text" id="provinciaPersona" required="required" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
