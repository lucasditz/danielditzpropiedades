...
function loadContratoData(editable,periodos,honorarios,deposito,id_inquilino,id_garante){
...
function checkInquilinoAndGarante(){
    if (selectedInquilino == undefined)
        ...
        if (selectedGarante == undefined)
            displayAlert("Atención", "Debe seleccionar el garante", doNothing);
        else{
            generateContract();
        }
    }
...
function getPeriodosValueArray(){
    ...
    console.log(JSON.stringify(alquilerPeriods));
