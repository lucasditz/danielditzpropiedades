...
function checkPersonaEmptyInput(){
    ...
    if ($('#fNacimientoPersona').val() == "")
        return("Debe ingresar la fecha de nacimiento de la persona");
    if ($('#callePersona').val() == "")
...
function savePersona(){
    ...
    $.ajax({
        ...
        data: { 'nombre': $('#nombrePersona').val(), 'apellido': $('#apellidoPersona').val(), 'dni': $('#dniPersona').val(),
            'fNacimiento': $('#fNacimientoPersona').val(), 'telefono': $('#telefonoPersona').val(), 'celular': $('#celularPersona').val(),
