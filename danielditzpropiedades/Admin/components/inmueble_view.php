                    ...
                    <div class="container" style="margin: 0 auto;width:80%;">
                        <div class="row" style="margin: 0 auto;width:80%;">
                            <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-5">
                                ...
                                <div class="short-div">
                                    <input type="text" id="calleInmueble" required="required" class="form-control" list='calleListid' readonly>
                            ...
                            <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                ...
                                <div class="short-div">
                                    <input type="text" id="nroInmueble" required="required" class="form-control" list='nroListid' readonly>
                            ...
                            <div class="form-group col-xs-12 col-sm-2 col-md-3 col-lg-2">
                                ...
                                <div class="short-div">
                                    <input type="text" id="pisoInmueble" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-2 col-md-3 col-lg-2">
                                <div class="short-div" style="text-align: left;">
                                ...
                                <div class="short-div">
                                    <input type="text" id="dptoInmueble" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin: 0 auto;width:80%;">
                            <div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-5">
                                ...
                                <div class="short-div">
                                    <input type="text" id="entreCalleInmueble" class="form-control" readonly>
                                </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                ...
                                <div class="short-div">
                                    <input type="text" id="zonaInmueble" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                ...
                                <div class="short-div">
                                    <input type="text" id="codPostalInmueble" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin: 0 auto;width:80%;">
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="short-div">
                                    <input type="text" id="ciudadInmueble" required="required" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="short-div" style="text-align: left;">
                                    <label class="control-label" for="provinciaInmueble">Provincia<span class="required">*</span></label>
                                </div>
                                <div class="short-div">
                                    <input type="text" id="provinciaInmueble" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container" style="margin: 0 auto;width:80%;">
                        <div class="row" style="margin: 0 auto;width:80%;">
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="short-div">
                                    <textarea id="comodidades" style="resize: none;" class="form-control"  rows="4" readonly></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin: 0 auto;width:80%;">
                            <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                ...
                                <div class="short-div">
                                    <input type="text" id="mts2" required="required" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-5 col-md-5 col-lg-4">
                                ...
                                <div class="short-div">
                                    <input type="text" id="valor" required="required" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
