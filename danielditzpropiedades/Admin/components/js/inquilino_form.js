...
var onSelectedInquilinoClick = function(selectedPerson){
    if (selectedPerson != undefined){
        ...
        selectedPerson.telefono.nro!=null?document.getElementById("telefonoInquilino_view").value=selectedPerson.telefono.nro:"";
        selectedPerson.celular.nro!=null?document.getElementById("celularInquilino_view").value=selectedPerson.celular.nro:"";
