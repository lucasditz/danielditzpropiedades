                    ...
                    <div class="container" style="margin: 0 auto;width:80%;">
                        <div class="row" style="margin: 0 auto;width:80%;">
                            <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-5">
                                <div class="short-div" style="text-align: left;">
                                    <label for="callePropietario_view" class="control-label">Calle</label>
                                </div>
                                <div class="short-div">
                                    <input type="text" id="callePropietario_view" class="form-control" list='calleListid' readonly>
                            ...
                            <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="short-div" style="text-align: left;">
                                    <label class="control-label" for="nroPropietario_view">Nro</label>
                                </div>
                                <div class="short-div">
                                    <input type="text" id="nroPropietario_view" class="form-control" list='nroListid' readonly>
                        ...
                        <div class="row" style="margin: 0 auto;width:80%;">
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="short-div" style="text-align: left;">
                                    <label for="ciudadPropietario_view" class="control-label">Ciudad</label>
                                </div>
                                <div class="short-div">
                                    <input type="text" id="ciudadPropietario_view" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="short-div" style="text-align: left;">
