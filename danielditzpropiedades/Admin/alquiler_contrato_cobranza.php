                                        ...
                                        <ul id="wizardNodes" class="wizard_steps anchor">
                                            <li>
                                                <a href="#step-1">
                                                    ...
                                                    <span class="step_descr">Datos Pago</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#step-2">
                                                    <span class="step_no">2</span>
                                                    <span class="step_descr">Datos Inquilino</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#step-3">
                                                    <span class="step_no">3</span>
                                                    <span class="step_descr">Confirmación Pago</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <!--<div style="height: 433px;" class="stepContainer" align="center" style="display: none;">-->
                                        <!-------- DATOS PAGO ------------>
                                        <div align="center" id="step-1" class="content" style="width: 80%; text-align: center; height: auto;">
                                            <?php include_once "components/cobranza_alquiler_mensual.php" ?>
                                        </div>
                                        <!-------- DATOS INQUILINO ------------>
                                        <div align="center" id="step-1" class="content" style="width: 80%; text-align: center; height: auto;">
