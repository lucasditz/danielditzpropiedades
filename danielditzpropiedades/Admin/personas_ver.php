                                            ...
                                            <div class="container" style="margin: 0 auto;width:80%;">
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="nombrePersona_input" required="required" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="apellidoPersona_input" required="required" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="dniPersona_input" required="required" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="fNacimientoPersona"  class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="telefonoPersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="celularPersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="container" style="margin: 0 auto;width:80%;">
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-5">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="callePersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="nroPersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-xs-12 col-sm-2 col-md-3 col-lg-2">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="pisoPersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-xs-12 col-sm-2 col-md-3 col-lg-2">
                                                        <div class="short-div" style="text-align: left;">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="dptoPersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row" style="margin: 0 auto;width:80%;">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="ciudadPersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                        <div class="short-div" style="text-align: left;">
                                                        ...
                                                        <div class="short-div">
                                                            <input type="text" id="provinciaPersona_input" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script src="js/personas_ver.js"></script>
