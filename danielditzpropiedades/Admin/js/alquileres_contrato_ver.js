...
function loadAlquilerData(){
    ...
    $.ajax({
        ...
        success: function (response){
            ...
            var garanteId="";
            if (propiedad.garante.id != null){
                garanteId=propiedad.garante.id;
            }

            loadContratoData(false,propiedad.periodos,propiedad.servicios,propiedad.honorarios,propiedad.deposito,propiedad.inquilino.id,garanteId);
